...
* @param {object} c1    Should have fields L,a,b
* @param {object} c2    Should have fields L,a,b
...
export default function ciede2000(c1,c2)
{
  ...
  let G = 0.5 * (1 - sqrt(pow(a_C1_C2 , 7.0) /
